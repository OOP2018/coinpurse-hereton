...
public class PurseTest {
	...
	public void testInsert() {
		...
		Valuable bank20 = makeBankNote(20);
		Valuable bank50 = makeBankNote(50);
		Valuable bank100 = makeBankNote(100);
		assertTrue(purse.insert(coin1));
		assertTrue(purse.insert(coin3));
		assertTrue(purse.insert(coin2));
		assertEquals(3, purse.count());
		assertTrue(purse.insert(bank20));
		assertTrue(purse.insert(bank100));
		assertTrue(purse.insert(bank50));
		// purse is full so insert should fail
		assertFalse(purse.insert(makeCoin(1)));
		assertFalse(purse.insert(makeBankNote(500)));
	...
	public void testWithdrawEverything() {
		...
		List<Valuable> coins = Arrays.asList(makeCoin(1.0), makeCoin(0.5), makeCoin(10.0), makeCoin(0.25),
				makeCoin(5.0));
